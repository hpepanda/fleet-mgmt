System.register(['angular2/core', '../services/getconfig.service', "../services/connection.service"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, getconfig_service_1, connection_service_1;
    ...
    return {
        ...
        execute: function() {
            DockerAppComponent = (function () {
                function DockerAppComponent(_configService, _connectionService) {
                    var _this = this;
                ...
                DockerAppComponent.prototype.getConfigCallback = function () {
                    ...
                    this.connectionService.connectionObservable.subscribe(function (wsData) {
                        ...
                        data.forEach(function (item) {
                            ...
                            if (!_this.dockers['item' + item.clientId]) {
                                _this.dockers['item' + item.clientId] = {
                                    ...
                                    ip: item.data[0].metadata.instanceIp,
                                    port: item.data[0].metadata.instancePort,
                        ...
                        var selectedDockerKeys = [];
                        _this.dockerKeys.forEach(function (dockerKey) {
                            if (wsData.source === _this.dockers[dockerKey].source)
                                selectedDockerKeys.push(dockerKey);
                        });
                        if (processedIds.length < selectedDockerKeys.length) {
                            selectedDockerKeys.forEach(function (dockerKey) {
                ...
                DockerAppComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [getconfig_service_1.ConfigService, connection_service_1.ConnectionService])
                ], DockerAppComponent);
