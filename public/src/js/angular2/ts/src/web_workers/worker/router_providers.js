System.register(['angular2/core', 'angular2/src/router/platform_location', './platform_location', 'angular2/src/router/router_providers_common'], function(exports_1, context_1) {
    "use strict";
