System.register(['angular2/core', 'angular2/src/facade/async', 'angular2/platform/browser', './metadata', './util', './constants', './downgrade_ng2_adapter', './upgrade_ng1_adapter', './angular_js'], function(exports_1, context_1) {
    "use strict";
