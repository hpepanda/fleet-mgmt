System.register(['./async_pipe', './uppercase_pipe', './lowercase_pipe', './json_pipe', './slice_pipe', './date_pipe', './number_pipe', 'angular2/src/facade/lang'], function(exports_1, context_1) {
    "use strict";
